---
title: "Discriminant Analysis code - owner gender"
output:
  html_document: default
  pdf_document: default
---
```{r}
#credits: Code structure drawn from Prof Jonathan Reuning-Scherer's code (Yale University)
library(ggplot2)
library(ggExtra)
library(heplots)
library(lubridate)
...
data <- read_excel(r"<insert relevant path>")

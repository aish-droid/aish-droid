---
title: "Discriminant Analysis code"
output: html_document
date: "2025-02-17"
credits: Functions used for analysis have been sourced from Prof Jonathan Reuning-Scherer's (Yale University) code
---
```{r}
library(ggplot2)
library(ggExtra)
...
data <- read_excel("data_trial2.xls")
